...
const Sidebar = ({ children }) => {
  ...
  return (
    <>
      <aside
        className={`lg:sticky top-0 z-10 py-2 px-1 min-w-fit h-screen    md:sticky md:w-auto lg:w-max fixed transition-all ${
          screen === "mobile" && "-translate-x-full invisible -z-20"
        }`}
      >
